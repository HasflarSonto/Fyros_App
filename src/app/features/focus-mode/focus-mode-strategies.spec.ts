  ...
  describe('PomodoroStrategy', () => {
    ...
    describe('getBreakDuration', () => {
      it('should return short break for cycles 1-3', () => {
        const result1 = strategy.getBreakDuration(1); // Current cycle 1
        const result2 = strategy.getBreakDuration(2); // Current cycle 2
        const result3 = strategy.getBreakDuration(3); // Current cycle 3
      ...
      it('should return long break for cycle 4', () => {
        const result = strategy.getBreakDuration(4); // Current cycle 4

        expect(result).toEqual({ duration: 900000, isLong: true });
      });

      it('should return short break after long break cycle', () => {
        const result = strategy.getBreakDuration(5); // Current cycle 5

        expect(result).toEqual({ duration: 300000, isLong: false });
      });

      it('should return long break every 4th cycle', () => {
        const result8 = strategy.getBreakDuration(8); // Current cycle 8
        const result12 = strategy.getBreakDuration(12); // Current cycle 12
